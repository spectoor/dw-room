function SucessModal() {
    const modalStyle = {border:"3px solid red", display:"flex",flexDirection:"column",alignItems:"center",height:"15rem",width:"50%",margin:"auto",gap:"1rem"}
  return (
    <div className="modal-wrapper" style={{border:"3px solid red", display:"flex",flexDirection:"column",alignItems:"center",height:"15rem",width:"50%",margin:"auto",gap:"1rem"}}>
      ...
      <button style={{borderRadius: "15px",padding:"0.5rem",width:"25%"}}>Download ics</button>
